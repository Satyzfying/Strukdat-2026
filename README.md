...
Try to implement the four pillars of OOP (Encapsulation, Abstraction, Inheritance, and Polymorphism). Note to myself in the future, don't use AI too much please.
